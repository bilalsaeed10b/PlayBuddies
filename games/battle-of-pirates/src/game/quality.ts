...
const TIERS: Record<Tier, Quality> = {
  ...
  1: { tier: 1, maxDpr: 1.5, particles: 0.7, trails: true, waves: 4, aimDots: 5, fancy: true, idleHalfRate: true },
  2: { tier: 2, maxDpr: 2, particles: 1, trails: true, waves: 6, aimDots: 6, fancy: true, idleHalfRate: false },
};
