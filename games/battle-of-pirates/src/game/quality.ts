...
const TIERS: Record<Tier, Quality> = {
  0: { tier: 0, maxDpr: 1, particles: 0.35, trails: false, waves: 2, aimDots: 7, fancy: false, idleHalfRate: true },
  1: { tier: 1, maxDpr: 1.5, particles: 0.7, trails: true, waves: 4, aimDots: 10, fancy: true, idleHalfRate: true },
  2: { tier: 2, maxDpr: 2, particles: 1, trails: true, waves: 6, aimDots: 13, fancy: true, idleHalfRate: false },
};
