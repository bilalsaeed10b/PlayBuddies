...
const TIERS: Record<Tier, Quality> = {
  0: { tier: 0, maxDpr: 1, particles: 0.35, trails: false, waves: 2, aimDots: 6, fancy: false, idleHalfRate: true },
  1: { tier: 1, maxDpr: 1.5, particles: 0.7, trails: true, waves: 4, aimDots: 7, fancy: true, idleHalfRate: true },
