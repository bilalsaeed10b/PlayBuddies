 ...
 * count, so one downgrade thins the particles, drops the ball trail and
...
const TIERS: Record<Tier, Quality> = {
  0: { tier: 0, maxDpr: 1, particles: 0.35, trails: false, fancy: false },
  1: { tier: 1, maxDpr: 1.5, particles: 0.7, trails: true, fancy: true },
  2: { tier: 2, maxDpr: 2, particles: 1, trails: true, fancy: true },
};
